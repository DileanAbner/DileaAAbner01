...
public class Steps {
	...
	public void o_usuario_preencher_o_formulario() throws Throwable {
	    m.preencher(e.getCampoNome(), "Flash code", "Preencher o campo nome");
	...
	@Then("^entao valido o texto falta pouco$")
	public void entao_valido_o_texto_falta_pouco() throws Throwable {
